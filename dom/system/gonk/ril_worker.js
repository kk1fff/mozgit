...
GsmPDUHelperObject.prototype = {
   ...
   */
  bcdChars: "0123456789*#,;",
  semiOctetToBcdChar: function semiOctetToBcdChar(semiOctet, supressException) {
    if (semiOctet >= 14) {
      if (supressException) {
        return "";
      } else {
   ...
   */
  readSwappedNibbleBcdString: function readSwappedNibbleBcdString(pairs, supressException) {
    let str = "";
    for (let i = 0; i < pairs; i++) {
